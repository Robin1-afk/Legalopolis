    ...
    <div id="wrapper">
        ...
        <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="jumbotron">
                        <h2>Formulario</h2>
                        <form action="eje_agregar.php" method="post"  enctype="multipart/form-data">
...
<br>
 <input type="text" class="form-control  text-center" name="cliente" required>
 <br>
<br>
<label for="">Radicado</label>
<br>
 <input type="text" class="form-control  text-center" name="radicado"required >
 <br>
<br>
 <input type="hidden" class="form-control  text-center" name="actualizacion"  required>
 

<label for="">Despacho</label>
<br>
 <input type="text" class="form-control  text-center" name="despacho" required >
...
<br>
 <input type="text" class="form-control  text-center" name="juez"  required>

 <br>
 <br>

 <input type="hidden" class="form-control  text-center" name="instancia_proceso" value="Espera" required  >
